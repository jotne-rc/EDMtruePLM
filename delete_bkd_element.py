...
def delete_breakdown_element(model: str, node: str, repository: str="TruePLMprojectsRep"):
    """
    ...
    """
    del_bd_elem_url = f"{plm_info['url']}/api/bkd/{repository}/{model}/{node}"
...
def main():
    ...
    delete_result = delete_breakdown_element(model, node)
    if delete_result:
