...
if __name__ == "__main__":
    ...
    target_model = 'Norway' # note that "model" is equivalent to project 
    target_node = "crane_state_module"
    target_property = 'crane_state_values'
    ...
    if token:
        ...
        json_data = '[{"index": "' + str(ts) + '", "dp_main_cyl": 14.7, "main_boom_angle": -3.2, "outer_boom_angle": 9.6, "extension_length_outer_boom": 2.1, "slewing_angle": 1.0}]'
